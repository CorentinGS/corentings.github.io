...
import { v as $$Image } from './pages/__nj5sQErc.mjs';
import 'clsx';

const __0_______assets_docker_infographie_jpg__ = new Proxy({"src":"/_astro/docker_infographie.DHAVvVnE.jpg","width":800,"height":2000,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/workspaces/corentings.github.io/src/assets/docker_infographie.jpg";
							}
...
const file = "/workspaces/corentings.github.io/src/content/blog/docker-and-go.mdx";
...
Content.moduleId = "/workspaces/corentings.github.io/src/content/blog/docker-and-go.mdx";
