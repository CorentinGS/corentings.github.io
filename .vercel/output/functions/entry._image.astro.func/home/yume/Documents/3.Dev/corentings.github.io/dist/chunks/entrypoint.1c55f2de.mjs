import 'cookie';
import { l as levels, d as dateTimeFormat, A as AstroCookies, a as attachCookiesToResponse, c as createAPIContext, b as callEndpoint, e as callMiddleware, L as Logger, f as AstroIntegrationLogger, g as getSetCookiesFromResponse } from '../manifest.b45dff09.mjs';
import { yellow, dim, bold, cyan, red, reset } from 'kleur/colors';
import { j as joinPaths, s as slash, p as prependForwardSlash, r as removeTrailingForwardSlash, c as collapseDuplicateSlashes } from './pages/image-endpoint.js.1be73898.mjs';
import { A as AstroError, G as GetStaticPathsRequired, j as InvalidGetStaticPathsReturn, k as InvalidGetStaticPathsEntry, l as GetStaticPathsExpectedParams, n as GetStaticPathsInvalidRouteParam, P as PageNumberParamNotFound, o as GetStaticPathsRemovedRSSHelper, N as NoMatchingStaticPathFound, p as PrerenderDynamicEndpointPathCollide, q as LocalsNotAnObject, R as ReservedSlotName, t as renderSlotToString, v as renderJSX, w as chunkToString, C as ClientAddressNotAvailable, S as StaticClientAddressNotAvailable, x as ResponseSentError, y as renderPage$1 } from './astro.b767b37f.mjs';
import 'clsx';
import 'node:fs';
import 'node:http';
import 'node:tls';
