...
🎙️✨
</p></div></div></section><section class="mx-auto w-full max-w-7xl lg:px-8 pb-10"><div class="relative px-4 sm:px-8 lg:px-12">${renderComponent($$result2, "Talks", $$Talks$2, {})}</div></section>${renderComponent($$result2, "Footer", $$Footer, {})}` }));
...
export { $$Icon as $, Config as C, Profile as P, TimelineCardType as T, $$Trans as a, $$Footer as b, $$Layout as c, $$Talks$2 as d, P as e, $$LanguageSelector as f, $$ThemeSwitcher as g, $$ViewTransitions as h, imgAvatar as i, talks as j, talks$1 as t };
