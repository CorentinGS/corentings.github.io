...
/* empty css                          */import fsBackend from 'i18next-fs-backend';
...
const $$Schema = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a$2 || (_a$2 = __template$2(['<script type="application/ld+json">', "<\/script>"])), unescapeHTML(JsonLd(item, space)));
...
const $$Talks$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const talks = [
    {
      title: "Introduction to Microservices with Go",
      date: "2023",
      ...
      description: "A talk about microservices, and how to build them with Go.",
      cta: "Learn more"
    },
    {
      title: "Introduction to AI and Ethical considerations",
      date: "2023",
      location: "Demi-Si\xE8cle",
      description: "A private talk about AI and its ethical considerations."
    }
  ];
  const podcasts = [{
    title: "Meet CorentinGS",
    date: "2023",
    location: "Avocado Growth : Portrait tech",
    description: "A podcast about my journey as a developer, and my vision of the future."
  }];
  return renderTemplate`${maybeRenderHead()}<div aria-labelledby="Conferences" class="md:border-l md:border-secondary-100 md:pl-6  mt-20 py-10"><div class="grid max-w-3xl grid-cols-1 items-baseline gap-y-8 md:grid-cols-4"><h2 class="text-sm font-semibold">Conferences</h2><div class="md:col-span-3"><div class="space-y-16">${talks.map((talk) => renderTemplate`${renderComponent($$result, "Card", $$Card, { ...talk })}`)}</div></div></div></div><div aria-labelledby="Podcasts" class="md:border-l md:border-secondary-100 md:pl-6  mt-20 py-10"><div class="grid max-w-3xl grid-cols-1 items-baseline gap-y-8 md:grid-cols-4"><h2 class="text-sm font-semibold">Podcasts</h2><div class="md:col-span-3"><div class="space-y-16">${podcasts.map((talk) => renderTemplate`${renderComponent($$result, "Card", $$Card, { ...talk })}`)}</div></div></div></div>`;
...
<\/script>`])), renderComponent($$result, "Layout", $$Layout, { "title": "CorentinGS" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead()}<div class="hoveranimation btn btn-accent btn-sm fixed bottom-12 right-5 z-50 hidden" id="btn-back-to-top"${addAttribute(createTransitionScope($$result2, "s7dmxdpk"), "data-astro-transition-persist")}>${renderComponent($$result2, "Icon", $$Icon, { "name": "lucide:arrow-up", "class": "h-6 w-6" })}</div><section class="lg:py-15 py-6 md:py-10 mx-auto w-full max-w-7xl lg:px-8"><div class="relative px-4 sm:px-8 lg:px-12"><div class="relative flex flex-col"><h2 class="text-2xl font-bold md:text-3xl lg:text-5xl">
I participated in several talks and have been interviewed for different podcasts.
</h2><p class="mt-8 text-xl">
I've been part of talks and podcasts — such a blast! Being live on stage, the energy, the vibe —
                    it's like we're all in it together. And podcasts? They're my sweet spot. It's not just opinions;
                    it's a genuine conversation, and that's where the real magic happens. Can't wait to share stories
                    and laughs with you! 🎙️✨
</p></div></div></section><section class="mx-auto w-full max-w-7xl lg:px-8 pb-10"><div class="relative px-4 sm:px-8 lg:px-12">${renderComponent($$result2, "Talks", $$Talks$1, {})}</div></section>${renderComponent($$result2, "Footer", $$Footer, {})}` }));
}, "/home/corentings/Documents/3.Dev/corentings.github.io/src/pages/talks.astro", "self");

const $$file = "/home/corentings/Documents/3.Dev/corentings.github.io/src/pages/talks.astro";
const $$url = "/talks";
...
export { $$Icon as $, Config as C, Profile as P, TimelineCardType as T, $$Trans as a, $$Footer as b, $$Layout as c, P as d, $$LanguageSelector as e, $$ThemeSwitcher as f, $$ViewTransitions as g, imgAvatar as i, talks as t };
