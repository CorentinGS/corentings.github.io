...
<Picture src={imgPlayingHall} formats={['avif', 'webp']}
...
<Picture src={imgPlay} formats={['avif', 'webp']}
...
<Picture class="grayscale mx-auto"  src={imgChessmoodOffice} formats={['avif', 'webp']} 
