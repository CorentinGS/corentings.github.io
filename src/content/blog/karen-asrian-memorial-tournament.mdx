---
heroImage: /src/assets/blog/karen_asrian.webp
category: Chess
...
import imgPlayingHall from '/src/assets/blog/karen_asrian_playing_hall.webp'
import imgPlay from '/src/assets/blog/karen_asrian_1.webp'
import imgChessmoodOffice from '/src/assets/blog/chessmood_office.webp'
...
<Image src={imgPlayingHall}
        alt="Karen asrian playing hall" quality="80" loading="lazy" class="w-[80%] mx-auto"
...
<Image src={imgPlay}
    alt="Karen Asrian play" quality="80" loading="lazy" class="w-[80%] mx-auto" width={800}
	height={800}/>


## Chessmood

Speaking of improvement, a big part of my chess journey wouldn't have been possible without the Chessmood team. Their training platform helped me climb over 300 points in online blitz and rapid chess ratings. 
...
<Image class="grayscale mx-auto"  src={imgChessmoodOffice} 
