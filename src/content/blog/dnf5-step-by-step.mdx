...
<br></br>Additionally, as it will be the default package manager in <a
    href={'https://github.com/rpm-software-management/dnf5/issues/411'} class="font-bold underline text-accent"
    target="_blank" rel="noopener">Fedora
...
<a href="https://twitter.com/GSCorentinDev" target="_blank" rel="noopener"
   class="font-bold underline text-accent">Twitter</a> or
<a href="https://corentings.dev/discord" target="_blank" rel="noopener"
   class="font-bold underline text-accent">Discord</a>.
